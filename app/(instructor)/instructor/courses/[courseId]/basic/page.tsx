...
const CourseBasics = async ({ params }: { params: { courseId: string } }) => {
  ...
  ]; //tao mot mang chua tat ca cac filed can tao mot course
  ...
  return (
    <div className="px-10">
      <AlertBanner isCompleted={isCompleted} missingFieldCount={missingFieldsCount} requiredFieldsCount={requiredFieldsCount} />
      <EditCourseForm
        course={course}
